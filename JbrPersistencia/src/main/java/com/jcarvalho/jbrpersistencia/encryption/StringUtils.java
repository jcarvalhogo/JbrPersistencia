 ...
 * specification. These encodings are specified in
 * <a href="http://download.oracle.com/javase/6/docs/api/java/nio/charset/Charset.html">
 * Standard charsets</a>.
 *
 * <p>
 ...
 * @see CharEncoding
 * @see
 * <a href="http://download.oracle.com/javase/6/docs/api/java/nio/charset/Charset.html">Standard
 * charsets</a>
...
public class StringUtils {
     ...
     * initialized, which should never happen since it is required by the Java
     ...
     * {@link UnsupportedEncodingException} is caught, which should never happen
     ...
     * bytes using the given charset, or {@code null} if the input byte array
     * was {@code null}.
     * @throws NullPointerException Thrown if {@link Charsets#UTF_8} is not
     * initialized, which should never happen since it is required by the Java
     * platform specification.
     ...
     * @param bytes The bytes to be decoded into characters, may be {@code null}
     * @return A new <code>String</code> decoded from the specified array of
     * bytes using the ISO-8859-1 charset, or {@code null} if the input byte
     * array was {@code null}.
     * @throws NullPointerException Thrown if {@link Charsets#ISO_8859_1} is not
     * initialized, which should never happen since it is required by the Java
     * platform specification.
     ...
     * @param bytes The bytes to be decoded into characters
     * @return A new <code>String</code> decoded from the specified array of
     * bytes using the US-ASCII charset, or {@code null} if the input byte array
     * was {@code null}.
     * @throws NullPointerException Thrown if {@link Charsets#US_ASCII} is not
     * initialized, which should never happen since it is required by the Java
     * platform specification.
     ...
     * @param bytes The bytes to be decoded into characters
     * @return A new <code>String</code> decoded from the specified array of
     * bytes using the UTF-16 charset or {@code null} if the input byte array
     * was {@code null}.
     * @throws NullPointerException Thrown if {@link Charsets#UTF_16} is not
     * initialized, which should never happen since it is required by the Java
     * platform specification.
     ...
     * @param bytes The bytes to be decoded into characters
     * @return A new <code>String</code> decoded from the specified array of
     * bytes using the UTF-16BE charset, or {@code null} if the input byte array
     * was {@code null}.
     * @throws NullPointerException Thrown if {@link Charsets#UTF_16BE} is not
     * initialized, which should never happen since it is required by the Java
     * platform specification.
     ...
     * @param bytes The bytes to be decoded into characters
     * @return A new <code>String</code> decoded from the specified array of
     * bytes using the UTF-16LE charset, or {@code null} if the input byte array
     * was {@code null}.
     * @throws NullPointerException Thrown if {@link Charsets#UTF_16LE} is not
     * initialized, which should never happen since it is required by the Java
     * platform specification.
     ...
     * @param bytes The bytes to be decoded into characters
     * @return A new <code>String</code> decoded from the specified array of
     * bytes using the UTF-8 charset, or {@code null} if the input byte array
     * was {@code null}.
     * @throws NullPointerException Thrown if {@link Charsets#UTF_8} is not
     * initialized, which should never happen since it is required by the Java
     * platform specification.
